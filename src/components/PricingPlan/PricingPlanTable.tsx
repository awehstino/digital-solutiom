...
const PricingPlanTable: React.FC = () => {
  ...
  return (
    <>
      <div className="pricing-area position-relative z-1 ptb-130 round-20">
        <div className="container style-one">
          <div className="row align-items-center mb-40">
            ...
            <div className="col-xl-6 col-lg-5">
              <div className="pricing-switch-wrap style-three position-relative d-flex justify-content-center ms-lg-auto">
          ...
          <div className="pricing-table style-two table-responsive">
