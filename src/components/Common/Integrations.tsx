        ...
        <div className="container style-one ptb-130">
          <div className="row justify-content-center">
            <div className="col-xl-8 col-md-10 text-center position-relative">
              <span
                className="section-subtitle d-inline-block text_primary fw-bold fs-14 ls-15 mb-12"
                data-aos="fade-up"
                data-aos-delay="100"
              ...
              <h2
                className="section-title style-one fw-medium text-center text-title mb-50 px-xxl-5 mx-xxl-5"
                data-aos="fade-up"
                data-aos-delay="200"
                data-aos-duration="1000"
                data-aos-once="true"
